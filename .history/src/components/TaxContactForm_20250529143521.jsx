...
function ContactForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      tfn,
      referral,
      sms_message: `Dear ${firstName}, OnlineTaxRefundToday accountant will be in touch with you soon. Please keep your phone handy for a call from us. Thank you for choosing us. please do not reply to this message.`,
      consent,
      processConsent,
      accName,
      bsb,
    ...
    <div className="col-10 col-lg-4 p-4 my-3 bg-warning rounded">
        <form id="contact-form" onSubmit={handleSubmit}>
            <div className=" form-group row justify-content-center px-4">                             
                    ...
                    <div className="pt-1">
                        <input onChange={handleChange} value={taxYear} placeholder="Mobile" name="taxYear" id="tax-year" type="select" autoComplete="off" className="form-control" required />
                        <select name="taxYear" id="tax-year">2024-2025</select>
                        <select name="taxYear" id="tax-year">2023-2024</select>
                        <select name="taxYear" id="tax-year">2022-2023</select>
                        <select name="taxYear" id="tax-year">2021-2022</select>
                        <select name="taxYear" id="tax-year">2020-2021</select>
                    </div>
                    <div className="pt-1">
                    ...
                    <div className=" pt-1 text-start">
                        <div className="">
                            ...
                            <span> I provide <Link to="/consent" className="text-dark text-decoration-underline">consent</Link> and authorize OnlineTaxRefundToday (ABN 72687528570 and Tax Agent 26262022) to add me as a client in the Tax Agent Portal.</span>
                        </div>
                    </div>
                    <div className=" pt-1 text-start">
                        <div className="">
                            ...
                            <span > Request no upfront fee option.</span>
                        </div>
                    </div>
                    {processConsent === true && (
                        <>  
