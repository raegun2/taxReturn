        ...
        <nav className="navbar navbar-expand-lg bg-dark navbar-dark py-1 fixed-top ">
            <div className="container bg-dark d-block">
                <div className="row justify-content-around align-items-center">
                    ...
                    <div className=" text-end col-6 flex-row d-flex justify-content-between">
                        <button className="btn btn-primary btn-md text-light " type="button">
                            <a href="tel:+61435488983"><i className="bi bi-telephone-fill"></i> +61 435 488 983</a>
                        </button>
