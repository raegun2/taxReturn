        ...
        <nav className="navbar navbar-expand-lg bg-dark navbar-dark py-1 fixed-top ">
            <div className="container bg-dark d-block">
                <div className="row justify-content-around align-items-center d-flex">
                    ...
                    <div className="text-lg-end col-1">
                    ...
                    <div className="col-2">
                        <button className="btn btn-primary btn-md" type="button">
                            <a className= "text-light"href="tel:+61435488983"><i className="bi bi-telephone-fill "></i> +61 435 488 983</a>
                        </button>
                    </div>
                    
                    <div className="col-5 text-end justify-content-end align-items-center">
