    ...
    <div className="col-10 col-lg-4 p-4 my-3 bg-warning rounded">
        <form id="contact-form" onSubmit={handleSubmit}>
            <div className=" form-group row justify-content-center px-4">                             
                    ...
                    <div className=" pt-1 align-items-end">
                        <div className="">
                            ...
                            <span className="padding-5"> I provide <Link to="/consent" className="text-dark text-decoration-underline">consent</Link> and authorize Same Day Tax refund (ABN 0000000000 and Tax Agent 000000000) to add me as a client in the Tax Agent Portal.</span>
                        </div>
                    </div>
                    <div className=" pt-1">
                        <div className="">
                            ...
                            <span className="padding-1 "> I would like to proceed my tax return with onlinetaxrefundtoday</span>
                        </div>
                    </div>
                    {processConsent === true && (
                        <>
