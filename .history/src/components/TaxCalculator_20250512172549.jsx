...
const TaxCalculator = () => {
  ...
  const handleClick = () => {
    setShowComment((changeStyle) => ({
      ...changeStyle, dislplay: changeStyle.display === "none" ? "flex" : "none"}));
  };
  const handleClick2 = () => {
  ...
  const handleClick3 = () => {
    setShowComment3((changeStyle) => ({
      ...changeStyle, dislplay: changeStyle.display === "none" ? "absolute" : "none"}));
  };  
        ...
        <div className="container rounded bg-info text-light p-4 ">
          ...
          <div className="container bg-light text-light rounded p-1">
            <form method="post" onSubmit={handleSubmit}>
              ...
              <label className="col-form-label">Total Income or Gross Payment:</label> <button className="btn btn-white" type="button" onClick={handleClick}><i className="bi bi-question-circle"></i></button> <div className="comment" style={showComment}><p>abc is abc</p></div>
