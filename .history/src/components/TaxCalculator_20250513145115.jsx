...
const TaxCalculator = () => {
  const [showComment, setShowComment1] = useState({display: "none"});
          ...
          <div className="container bg-light text-light rounded p-1">
            ...
            <form method="post" onSubmit={handleSubmit}>
              <div className="row justify-content-center text-dark text-center">
                ...
                <div className="comment" style={showComment1}><p> add up all the income and input <br /> the total income that you earn from</p></div>
                ...
                <div className="comment" style={showComment2}><p> add up all the income and input <br /> the total income that you earn from</p></div>
                <div className="input-group mb-3 w-75">
                  <div className="input-group-prepend">
                    <span className="input-group-text">$</span>
                  </div>
                ...
                <div className="comment" style={showComment3}><p> add up all the income and input <br /> the total income that you earn from</p></div><div className="input-group mb-3 w-75">
                  <div className="input-group-prepend">
                    <span className="input-group-text">$</span>
                  </div>
                  <input
