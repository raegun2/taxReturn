        ...
        <div className="container rounded bg-info text-light p-4 ">
          ...
          <div className="container bg-light text-light rounded p-1">
            ...
            <form method="post" onSubmit={handleSubmit}>
              ...
              <label className="col-form-label">Total Income or Gross Payment: <i onClick={handleClick} className="bi bi-question-circle"></i><div className="comment" style={showComment}><p>abc is abc</p></div></label> 
