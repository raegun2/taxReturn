          ...
          <div className="container bg-light text-light rounded p-1">
            <form method="post" onSubmit={handleSubmit}>
              ...
              <label className="col-form-label">Total Income or Gross Payment: <i className="question_icon bi bi-question-circle" onClick={handleClick}></i> <div className="comment" style={showComment}><p>abc is abc</p></div></label>
                ...
                <label className="col-form-label">Total tax withheld:<i className="question_icon bi bi-question-circle" onClick={handleClick}></i> <div className="comment" style={showComment}><p>abc is abc</p></div></label>
                <div className="input-group mb-3 w-75">
                  <div className="input-group-prepend">
                    <span className="input-group-text">$</span>
                  </div>
                ...
                <label className="col-form-label">Total Applicable Deductions:<i className="question_icon bi bi-question-circle" onClick={handleClick}></i> <div className="comment" style={showComment}><p>abc is abc</p></div></label>
                <div className="input-group mb-3 w-75">
                  <div className="input-group-prepend">
                    <span className="input-group-text">$</span>
                  </div>
