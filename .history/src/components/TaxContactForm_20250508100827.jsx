...
function ContactForm() {
    ...
    const handleSubmit = async (e) => {
      ...
      const payload = {
        ...
        phone: phone,
        message: `${firstName}, Your accountant will be in touch with you soon. Please keep your phone handy for a call from us. Thank you for choosing Same Day Tax Refund.`,
