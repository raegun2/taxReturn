          ...
          <div className="container bg-light text-light rounded p-1">
            ...
            <form method="post" onSubmit={handleSubmit}>
              <div className="row justify-content-center text-dark text-center">
                <label className="col-form-label">Total Income or Gross Payment: <i style={{ marginLeft: '10px', cursor: 'pointer'}} onMouseEnter={() => handleVisibleComment(1)} onMouseLeave={handleMouseLeave} className="bi bi-question-circle"></i></label>
                {
                  visibleComment === 1 && (
