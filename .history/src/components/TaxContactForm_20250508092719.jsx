...
function ContactForm() {
    ...
    const handleSubmit = async (e) => {
      ...
      const payload = {
        ...
        tfn: tfn,
        referral: referral,
        sms_message: `2Dear ${firstName}, Your accountant will be in touch with you soon. Please keep your phone handy for a call from us. Thank you for choosing Same Day Tax Refund. WWW.SAMEDAYTAXREFUND.COM.AU`,
      ...
      try {
        const res = await fetch("http://localhost/mytax/sms/send_sms.php", {
          method: "POST",
          headers: {
      ...
      try {
        const res = await fetch("http://localhost/mytax/email/send_email.php", {
          method: "POST",
          headers: {
            "Content-Type": "application/json"
          },
