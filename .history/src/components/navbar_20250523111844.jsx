        ...
        <nav className="navbar navbar-expand-lg bg-dark navbar-dark py-1 fixed-top ">
            <div className="container bg-dark d-block">
                <div className="row justify-content-around align-items-center">
                    ...
                    <div className=" text-end col-5 flex-row d-flex">
                        <button className="btn btn-primary btn-md " type="button">
                            <phone to="tel:1300 000 000" className="text-decoration-none text-light"><i class="bi bi-telephone-outbound"></i>1300 000 000</phone>
                        </button>
