...
function Navbar() {
  ...
  return (
    <nav className="navbar navbar-expand-lg bg-dark navbar-dark py-1 pe-2 fixed-top">
      <div className="container bg-dark d-block">
        <div className="row justify-content-between align-items-center px-2">
          ...
          <div className="col-2 text-start bg-danger">
                
          </div>

          <div className="col-lg-7 col-4 text-end">
            <button
