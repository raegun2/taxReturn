              ...
              <ul className="navbar-nav ms-auto">
                <li className="nav-item dropdown">
                  ...
                  <ul className="dropdown-menu dropdown-menu-dark" id="taxReturnList">
                    <li>
                      <Link to="TaxReturn2025" className="dropdown-item" onClick={handleNavClick}>
                        Tax Return 2025
                      </Link>
                    </li>
                    <li>
                      <Link to="TaxReturn2024" className="dropdown-item" onClick={handleNavClick}>
                        Tax Return 2024
                      </Link>
                    </li>
                    <li>
                      <Link to="TaxReturn2023" className="dropdown-item" onClick={handleNavClick}>
                        Tax Return 2023
                      </Link>
                    </li>
                    <li>
                      <Link to="FeesAndCharges" className="dropdown-item" onClick={handleNavClick}>
                        Fees & Charges
                      </Link>
                    </li>
                  </ul>
