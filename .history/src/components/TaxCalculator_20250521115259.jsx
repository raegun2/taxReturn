          ...
          <div className="container bg-light text-light rounded p-1">
            ...
            <form method="post" onSubmit={handleSubmit}>
              <div className="row justify-content-center text-dark text-center">
                <div className="col-form-label">Total Income or Gross Payment: <div style={{ backgroundColor: "red", width: '500px'}} onMouseEnter={() => handleVisibleComment(1)} onMouseLeave={handleMouseLeave}><i className="bi bi-question-circle"></i></div></div>
                {
                  visibleComment === 1 && (
