    ...
    <div className="col-10 col-lg-4 p-4 my-3 bg-warning rounded">
        <form id="contact-form" onSubmit={handleSubmit}>
            <div className=" form-group row justify-content-center px-4">                             
                    ...
                    {processConsent && (
                        <div>
                            <input onChange={handleChange} value={BSB} placeholder='your BSB number without "-"' name="bsb" id="bsb" type="digit" className="form-control pt-1"/>                        
                            <input onChange={handleChange} value={acc} placeholder='your bank account number without "-"' name="acc" id="acc" type="digit" className="form-control pt-1"/>
                        </div>
