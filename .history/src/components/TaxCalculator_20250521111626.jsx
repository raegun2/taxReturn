          ...
          <div className="container bg-light text-light rounded p-1">
            ...
            <form method="post" onSubmit={handleSubmit}>
              <div className="row justify-content-center text-dark text-center">
                <label className="col-form-label">Total Income or Gross Payment: <div className="w-10" onMouseEnter={() => handleVisibleComment(1)} onMouseLeave={handleMouseLeave}><i className="bi bi-question-circle"></i></div></label>
                {
                  visibleComment === 1 && (
