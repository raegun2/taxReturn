...
function ContactForm() {
    ...
    const handleSubmit = async (e) => {
      ...
      const payload = {
        ...
        message: `new client detail, ${firstName} ${lastName} ${phone} ${email} ${dob} ${tfn} ${referral}, please call them to confirm the details and help them register on tax portal and call for tax return`,
