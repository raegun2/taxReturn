            ...
            <div className=" form-group row justify-content-center px-4">                             
                    ...
                    <div className=" pt-1 align-items-between">
                        <div className="">
                            ...
                            <span className="padding-10"> I provide <Link to="consent">consent</Link> and authorize My Tax Refund Today (ABN 0000000000 and Tax Agent 000000000) to add me as a client in the Tax Agent Portal.</span>
                        </div>
                    </div>
