                            ...
                            <ContactForm /> 
                                <div className="col-lg-6 pt-5 order-lg-1">
                                    <div className="row justify-content-center">
                                        ...
                                        <gmp-map center="-27.537172317504883,153.07904052734375" zoom="14" map-id="DEMO_MAP_ID">
                                            <gmp-advanced-marker position="-27.537172317504883,153.07904052734375" title="My location"></gmp-advanced-marker>
                                        </gmp-map>    
                                    </div>
                                </div>
