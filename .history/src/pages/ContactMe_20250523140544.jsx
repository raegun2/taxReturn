                            ...
                            <ContactForm /> 
                                <div className="col-lg-6 pt-5 order-lg-1">
                                    <div className="row justify-content-center">
                                        ...
                                        <gmpx-api-loader key="AIzaSyBp7RqXecG5XhF3qIdmblzRuWjqoP9tTPI" solution-channel="GMP_QB_locatorplus_v11_c"></gmpx-api-loader>
                                        <gmpx-store-locator map-id="82ba9678c475416dcdbdf76c"></gmpx-store-locator>  
                                    </div>
                                </div>
