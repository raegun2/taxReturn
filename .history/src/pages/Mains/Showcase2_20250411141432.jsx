                            ...
                            <div className="card h-100">  
                                <div className="card-body">
                                    <div className="">
                                        ...
                                        <h3 className="fw-bold">FILL IN THE FORM</h3>
                                    </div>
                                    <div className="">
                                    <p className="card-text py-3">Fill in the online form above or email your group certificate [PAYG summary] to info@taxrefundtoday.com.au</p>
                                    </div>
                        ...
                        <div className="col-lg">
                            <div className="card h-100">
                                <div className="card-body">
                                    ...
                                    <div className="">
                                        <p className="card-text py-3">A qualified tax accountant will call you and discuss your tax situation. They will then give you a FREE refund estimate. You then have the option to either wait two weeks or you can ask us for our 1-hour refund option.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
