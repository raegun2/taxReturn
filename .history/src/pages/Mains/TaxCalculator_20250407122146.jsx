...
const TaxCalculator = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (taxRefund < 0) {
      setResult(`You owe $${Math.abs(taxRefund)} <br> to Australian Tax office.
      contact your tax agent now!`);
    } else if (taxRefund > 0) {
      setResult(`You will receive a tax refund of <br> $${taxRefund}.`);
    } else {
    ...
    <>
        ...
        <div className="container rounded bg-dark text-light p-4 ">
          ...
          <div className="container bg-dark text-light">
            ...
            {result && 
              <div className="row justify-content-center">
                <div className="col-lg-5 align-items-start"><h3 className="mt-3">{result}</h3></div>
                <div className="col-lg-5"> 
                  <h3>Get Your Tax Refund Today!</h3>
                  <Link to="TaxReturn2025"><button className="btn btn-primary">Start Your Tax Return</button></Link>
                </div>
              </div>
            }
