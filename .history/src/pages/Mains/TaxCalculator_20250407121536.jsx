    ...
    <>
        ...
        <div className="container rounded bg-dark text-light p-4 ">
          ...
          <div className="container bg-dark text-light">
            ...
            {result && 
              <div className="col-sm-12 pt-3 justify-content-center flex-direction-row">
                <div className="col-lg-5"><h3 className="mt-3">{result}</h3></div>
                <div className="col-lg-5"> 
                  <h3>Get Your Tax Refund Now!</h3>
