                    ...
                    <div className="row text-center g-2" >
                        <div className="col-lg ">
                            <div className="card h-100">  
                                <div className="bg-primary card-body A qualified tax accountant will call you and discuss your tax situation. They will then give you a FREE refund estimate. You then have the option to either wait two weeks or you can ask us for our 1-hour refund option.rounded-circle">
                                    <div className="py-3">
