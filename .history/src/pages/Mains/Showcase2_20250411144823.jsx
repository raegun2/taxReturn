...
return ( 
    <>
        ...
        <section className="stepsToRefund bg-dark text-center vw-100">
                ...
                <h2 className="fw-bolder text-dark pb-3">Your Tax Refund</h2>
                    <div className="row text-center g-1" >
                        <div className="col-lg ">
                            <div className="card h-100 border-white">  
                                <div className="bg-primary card-body rounded-circle p-3">
                                    ...
                                    <div className="">
                                        <p className="card-text mb-3 p-2">Fill in the online form above or email your group certificate [PAYG summary] to info@taxrefundtoday.com.au</p>
                                    </div>
                        ...
                        <div className="bg-warning card-body rounded-circle p-3">
                                    ...
                                    <div className="">
                                    <p className="card-text mb-3 p-2">A qualified tax accountant will call you and discuss your tax situation. They will then give you a FREE refund estimate. You then have the option to either wait two weeks or you can ask us for our 1-hour refund option.</p>
