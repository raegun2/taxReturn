...
function MainPage1() {
    ...
    return (
        <>
            ...
            <div className="container pb-2 t text-white d-block">
            <h2 className="text-warning fw-bold">3 steps to Get</h2>
            <h2 className="fw-bolder text-dark pb-3">Your Tax Refund</h2>
                <div className="row text-center justify-content-evenly pb-3 flex-shrink-0">
                    <div className="col-lg-4 ">
                        <div className="card border-0 bg-light" style={{height: "40vh", width: "20vw"}}>  
