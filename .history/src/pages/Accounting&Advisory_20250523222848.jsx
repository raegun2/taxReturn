...
import { xeroLogo } from "../src/assets/xero-certified-advisor-logo.jpg";
import { myobLogo } from "../src/assets/myob-logo.jpg";
import { quickbooksLogo } from "../src/assets/quickbooks-logo.jpg";
import { xeroServices } from "../src/assets/xero-services2.jpg";
...
export default function AccountingAdvisory() {
    ...
    return (
        <>
            <section ref={content1Useref} className=" text-dark pt-3 pb-2 text-center d-flex flex-column">
                <div className="row">
                ...
                <div className="container h-50 py-3">
                    <div className="row">    
                        <div className="col-xl-4 p-4 bg-info flex-grow-0 text-center">
                            <img src={xeroServices} alt="Small Business" style={{height: "400px"}}/>
                        </div>
