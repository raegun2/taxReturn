...
$config_pass = include('/home3/onlineta/config.php'); // Adjust the path to your config file
if (!$config_pass) {
...
file_put_contents('debug_insert_log.txt', print_r($data, true));
...
if ($stmt->execute()) {
    ...
    $config = ClickSend\Configuration::getDefaultConfiguration()
                ->setUsername($config_pass['excellentaccountant@outlook.com'])
                ->setPassword($config_pass['72C2D3EC-A5F0-04B6-E744-96D1B73563B4']);
    $response = [];
    ...
    try {
        ...
        $sms->setBody($body);
        $sms->setTo(+61411111111 ); //test number +61411111111 or $to
